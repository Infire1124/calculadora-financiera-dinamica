...
let datosParaExportar = []; // Aquí guardaremos los resultados de cada año
// --- DICCIONARIO INTERNACIONAL AMPLIADO (CON INDIA Y TAIWÁN NATIVO) ---
const idiomas = {
    es: {
        titulo: "Calculadora Patrimonial Global", subtitulo: "Plataforma internacional para proyecciones financieras de alto rendimiento",
    ...
    en: {
        titulo: "Global Wealth Calculator", subtitulo: "International platform for high-performance financial projections",
    ...
    pt: {
        titulo: "Calculadora de Patrimônio Global", subtitulo: "Plataforma internacional para projeções financeiras de alto rendimento",
    ...
    ru: {
        titulo: "Глобальный Калькулятор Капитала", subtitulo: "Международная платформа для высокоэффективного финансового прогнозирования",
    ...
    ar: {
        titulo: "حاسبة الثروة العالمية", subtitulo: "منصة دولية للتوقعات المالية عالية الأداء",
        configPlan: "إعدادات الخطة الشاملة", idiomaApp: "لغة الواجهة", monedaBase: "عملة الاستثمار", invInicial: "الاستثمار الأولي",
        aportesFases: "المساهمات الشهرية حسب المراحل", fase1: "المرحلة ١ (سنوات ١-٥):", fase2: "المرحلة ٢ (سنوات ٦-١٣):", fase3: "المرحلة ٣ (سنوات ١٤-٣٠):",
        aportesExtra: "إيداعات إضافية / فرعية", frecuencia: "التكرار", montoExtra: "مبلغ الإيداع", anosSimular: "السنوات المحاكاة",
        interesAnual: "العائد السنوي (%)", inflacionAnual: "التضخم (%)", patrimonioFuturo: "رأس المال المتوقع (المستقبلي)", retiroSeguro: "السحب الشهري الآمن (٤%)",
        proyeccionGraf: "العرض الدولي لنمو رأس المال", btnCalcular: "حساب الخطة", btnReiniciar: "إعادة ضبط",
        frecuencias: ["لا يوجد", "كل شهر", "كل ٦ أشهر", "كل ١٢ شهراً (سنوي)"],
        lineas: ["إجمالي رأس المال", "القوة الشرائية الحقيقية", "إجمالي الإيداعات"],
        msgTitulo: "المقاييس الإحصائية للنموذج", msgEn: "تحت هذا المخطط الاستراتيجي للمحاكاة لمدة", msgAniosTendras: "عامًا، يرتفع رأس مالك المقدر إلى",
        msgDesc1: "ترسم النمذجة الرياضية المتقدمة التطور المتوقع لأموالك بناءً على معايير الفائدة المركبة والتقلبات المحددة.",
        msgDesc2: "ملاحظة تحليلية: التغييرات الطفيفة في عوائد الاستثمار أو معدلات التضخم تؤدي إلى اختلافات جذرية في رأس المال النهائي بسبب الأثر التراكمي.",
        footer: "حاسبة الثروة العالمية الذكية • دعم دولي مستقل متعدد العملات", dir: "rtl"
    },
    hi: {
        titulo: "वैश्विक संपत्ति कैलकुलेटर", subtitulo: "उच्च प्रदर्शन वित्तीय अनुमानों के लिए अंतर्राष्ट्रीय मंच",
        configPlan: "ग्लोबल प्लान कॉन्फ़िगरेशन", idiomaApp: "इंटरफ़ेस की भाषा", monedaBase: "निवेश की मुद्रा", invInicial: "प्रारंभिक निवेश",
        aportesFases: "चरणों के अनुसार मासिक योगदान", fase1: "चरण 1 (वर्ष 1-5):", fase2: "चरण 2 (वर्ष 6-13):", fase3: "चरण 3 (वर्ष 14-30):",
        aportesExtra: "अतिरिक्त / अतिरिक्त योगदान", frecuencia: "आवृत्ति", montoExtra: "योगदान राशि", anosSimular: "सिम्युलेट करने के लिए वर्ष",
        interesAnual: "वार्षिक ब्याज (%)", inflacionAnual: "मुद्रास्फीति (%)", patrimonioFuturo: "अनुमानित संपत्ति (भविष्य)", retiroSeguro: "सुरक्षित मासिक निकासी (4%)",
        proyeccionGraf: "अंतर्राष्ट्रीय पूंजी प्रक्षेपण", btnCalcular: "योजना की गणना करें", btnReiniciar: "पैरामीटर रीसेट करें",
        frecuencias: ["कोई नहीं", "हर महीने", "हर 6 महीने में", "हर 12 महीने में (वार्षिक)"],
        lineas: ["कुल संपत्ति", "वास्तविक क्रय शक्ति", "कुल जमा"],
        msgTitulo: "MODEL STATISTICAL ANALYTICS", msgEn: "के लिए इस रणनीतिक सिमुलेशन के तहत", msgAniosTendras: "वर्षों में, आपकी अनुमानित पूंजी तक पहुँच जाएगी",
        msgDesc1: "उन्नत गणितीय मॉडलिंग चक्रवृद्धि ब्याज और नियंत्रित अस्थिरता सूचकांकों के आधार पर आपके फंड के अनुमानित विकास को ट्रैक करता है।",
        msgDesc2: "विश्लेषणात्मक नोट: रिटर्न या मुद्रास्फीति में मामूली बदलाव अंतिम संपत्ति पर घातीय प्रभाव डालते हैं। विभिन्न परिदृश्यों का परीक्षण करें।",
        footer: "इंटेलिजेंट ग्लोबल वेल्थ कैलकुलेटर • स्वतंत्र मल्टी-करेंसी अंतर्राष्ट्रीय सहायता", dir: "ltr"
    },
    zh: {
        titulo: "全球资产配置计算器", subtitulo: "用于高回报财务预测的国际化平台",
        configPlan: "全球方案配置", idiomaApp: "界面语言", monedaBase: "投资结算货币", invInicial: "初始资产投入",
        aportesFases: "分阶段每月定期投入", fase1: "第一阶段 (1-5年):", fase2: "第二阶段 (6-13年):", fase3: "第三阶段 (14-30年):",
        aportesExtra: "额外/追加单笔投入", frecuencia: "追加频率", montoExtra: "追加金额", anosSimular: "模拟持有时长 (年)",
        interesAnual: "预期年化收益 (%)", inflacionAnual: "通货膨胀率 (%)", patrimonioFuturo: "期末预估资产总值", retiroSeguro: "每月安全提取金 (4% 规则)",
        proyeccionGraf: "跨国资本增长曲线预测", btnCalcular: "执行测算", btnReiniciar: "重置所有参数",
        frecuencias: ["无追加", "每月追加", "每半年追加", "每12个月 (按年追加)"],
        lineas: ["资产总市值", "剔除通胀实际购买力", "累计本金投入"],
        msgTitulo: "数据模型数理统计摘要", msgEn: "在当前复利策略模型下，持有", msgAniosTendras: "年后，您的全球期末总资产预计将达到",
        msgDesc1: "该高级金融数学模型基于复利累积效应以及通胀对冲变动，精确绘制出资产生命周期的远期财富演变轨迹。",
        msgDesc2: "数据风控提示：基准回报率 or 通胀率的微小偏差，均会在长周期内产生巨大的指数级分化误差。建议开展多组压力测试。",
        footer: "全球智能资产管理系统 • 独立多币种海外结算技术支持", dir: "ltr"
    },
    "zh-tw": {
        titulo: "全球資產配置計算器", subtitulo: "用於高回報財務預測的國際化平台",
        configPlan: "全球方案配置", idiomaApp: "介面語言", monedaBase: "投資結算貨幣", invInicial: "初始資產投入",
        aportesFases: "分階段每月定期投入", fase1: "第一階段 (1-5年):", fase2: "第二階段 (6-13年):", fase3: "第三階段 (14-30年):",
        aportesExtra: "額外/追加單筆投入", frecuencia: "追加頻率", montoExtra: "追加金額", anosSimular: "模擬持小時長 (年)",
        interesAnual: "預期年化收益 (%)", inflacionAnual: "通貨膨脹率 (%)", patrimonioFuturo: "期末預估資產總值", retiroSeguro: "每月安全提取金 (4% 規則)",
        proyeccionGraf: "跨國資本增長曲線預測", btnCalcular: "執行測算", btnReiniciar: "重置所有參數",
        frecuencias: ["無追加", "每月追加", "每半年追加", "每12個月 (按年追加)"],
        lineas: ["資產總市值", "剔除通脹實際購買力", "累計本金投入"],
        msgTitulo: "數據模型數理統計摘要", msgEn: "在當前複利策略模型下，持有", msgAniosTendras: "年後，您的全球期末總資產預計將達到",
        msgDesc1: "該高級金融數學模型基於複利累積效應以及通脹對衝變動，精確繪製出資產生命週期的遠期財富演變軌跡。",
        msgDesc2: "數據風控提示：基準回報率或通貨膨脹率的微小偏差，均會在長週期內產生巨大的指數級分化誤差。建議開展多組壓力測試。",
        footer: "全球智能資產管理系統 • 獨立多幣種海外結算技術支援", dir: "ltr"
    },
    ja: {
        titulo: "グローバル資産形成シミュレーター", subtitulo: "高パフォーマンスの財務予測のための国際プラットフォーム",
        configPlan: "シミュレーション設計", idiomaApp: "システム言語", monedaBase: "投資決済通貨", invInicial: "初期投資額",
        aportesFases: "フェーズ別積立月額", fase1: "フェーズ1 (1-5年):", fase2: "フェーズ2 (6-13年):", fase3: "フェーズ3 (14-30年):",
        aportesExtra: "臨時/追加投資オプション", frecuencia: "追加頻度", montoExtra: "追加投資額", anosSimular: "運用シミュレーション期間 (年)",
        interesAnual: "想定年利 (%)", inflacionAnual: "インフレ率 (%)", patrimonioFuturo: "将来の推定総資産額", retiroSeguro: "毎月の安全な取り崩し額 (4%)",
        proyeccionGraf: "国際資本成長予測曲線", btnCalcular: "試算を実行", btnReiniciar: "数値をリセット",
        frecuencias: ["なし", "毎月", "6ヶ月ごと", "12ヶ月ごと (毎年)"],
        lineas: ["総資産総額", "インフレ調整後実質購買力", "累計元本入金額"],
        msgTitulo: "数理モデル統計アナリティクス", msgEn: "この長期運用シミュレーションにおいて、期間", msgAniosTendras: "年での期末想定総資産は、次の金額に達します",
        msgDesc1: "本高度数理モデリングは、複利効果および物価変動調整を考慮し、お客様のポートフォリオの将来的な軌道を精密にプロットします。",
        msgDesc2: "分析上の注意：利回りやインフレ率のわずかな変動が、期間末の資産総額に指数関数的な格差をもたらします。複数の市場環境で検証してください。",
        footer: "インテリジェント・グローバル資産計算システム • 独立系マルチ通貨インターナショナルサポート", dir: "ltr"
    },
    ko: {
        titulo: "글로벌 자산 포트폴리오 계산기", subtitulo: "고성능 재무 예측을 위한 국제 플랫폼",
        configPlan: "글로벌 시뮬레이션 설정", idiomaApp: "시스템 언어", monedaBase: "투자 결제 통화", invInicial: "초기 투자 자본",
        aportesFases: "단계별 월 정기 납입액", fase1: "1단계 (1-5년):", fase2: "2단계 (6-13년):", 기: "3단계 (14-30년):",
        aportesExtra: "추가 / 임시 추가 납입", frecuencia: "납입 주기", montoExtra: "추가 납입 금액", anosSimular: "시뮬레이션 기간 (년)",
        interesAnual: "기대 연수익률 (%)", inflacionAnual: "물가상승률 (%)", patrimonioFuturo: "미래 추정 자산 총액", retiroSeguro: "안전 월 은퇴 자금 (4% 룰)",
        proyeccionGraf: "국제 자본 성장 예측 곡선", btnCalcular: "분석 실행", btnReiniciar: "매개변수 초기화",
        frecuencias: ["없음", "매월", "6개월마다", "12개월마다 (매년)"],
        lineas: ["추정 총자산", "실질 구매력 평가지수", "누적 원금 총액"],
        msgTitulo: "데이터 모델 통계 요약", msgEn: "본 복리 시뮬레이션 모델에 의거하여,", msgAniosTendras: "년 보유 시 귀하의 기대 만기 자산은 다음과 같습니다",
        msgDesc1: "이 고급 금융 수학 모델링은 복리 연산 구조 및 제어된 변동성 지표에 따라 자산의 장기 성장 궤적을 도출합니다.",
        msgDesc2: "분석적 각주: 수익률이나 물가 지수의 미세한 변화는 장기 실행 시 최종 만기 자산에 기하급수적인 격차를 발생시킵니다.",
        footer: "인텔리전트 글로벌 자산 시뮬레이터 • 독립형 다중 통화 지원 시스템", dir: "ltr"
    },
    uk: {
        titulo: "Глобальний Калькулятор Капіталу", subtitulo: "Міжнародна платформа для високоефективного фінансового прогнозування",
        configPlan: "Конфігурація глобального плана", idiomaApp: "Мова інтерфейсу", monedaBase: "Валюта інвестицій", invInicial: "Початкові інвестиції",
        aportesFases: "Щомісячні внески по фазах", fase1: "Фаза 1 (1-5 років):", fase2: "Фаза 2 (6-13 років):", fase3: "Фаза 3 (14-30 років):",
        aportesExtra: "Додаткові внески", frecuencia: "Періодичність", montoExtra: "Сумма внеску", anosSimular: "Років симуляції",
        interesAnual: "Річний дохід (%)", inflacionAnual: "Інфляція (%)", patrimonioFuturo: "Очікуваний капітал (майбутній)", retiroSeguro: "Безпечне щомісячне виведення (4%)",
        proyeccionGraf: "Міжнародна проекція капіталу", btnCalcular: "Розрахувати план", btnReiniciar: "Скинути параметри",
        frecuencias: ["Немає", "Щомісяця", "Кожні 6 місяців", "Кожні 12 місяців (Щорічно)"],
        lineas: ["Загальний капітал", "Реальна купівельна спроможність", "Всього депозитів"],
        msgTitulo: "Статистичні метрики модели", msgEn: "В рамках цієї стратегічної симуляції за", msgAniosTendras: "років ваш прогнозований капітал досягне",
        msgDesc1: "Передове математичне моделювання відображає розрахункову траєкторію розвитку ваших інвестицій з урахуванням складних процентів та індексації інфляції.",
        msgDesc2: "Аналітична довідка: Мінімальні зміни базової прибутковості або інфляції створюють експоненціальні коливання кінцевого капіталу.",
        footer: "Розумний Глобальний Калькулятор Капіталу • Незалежна міжнародна мультивалютна підтримка", dir: "ltr"
    }
};
